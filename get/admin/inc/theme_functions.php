    ...
    /*var_dump($classes);*/
		foreach ($pagesSorted as $page) {
			...
			if ($page['menuStatus'] == 'Y') {
				...
				$menu .= '<li class="header_menu-item"><a class="header_menu-link'.$classes.'" href="'. find_url($page['url'],$page['parent']) . '" title="'. encode_quotes(cl($page['title'])) .'">'.strip_decode($page['menu']).'</a></li>'."\n";
			}
		}
